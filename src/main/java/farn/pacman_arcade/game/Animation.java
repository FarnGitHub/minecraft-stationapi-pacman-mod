...
public class Animation {
    ...
    public void animateFlashingGhost(Minecraft mc, Screen gui, int direction, int x, int y) {
        ...
        GL11.glBindTexture((int)3553, (int)mc.textureManager.getTextureId("/assets/pacman_arcade/pacman_textures/sprites.png"));
    ...
    public void animateMenu(Minecraft mc, Screen gui, int x, int y) {
        GL11.glColor4f((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
        GL11.glEnable((int)3042);
        GL11.glBindTexture((int)3553, (int)mc.textureManager.getTextureId("/assets/pacman_arcade/pacman_textures/animation.png"));
